VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} HeadphoneStock 
   Bindings        =   "HeadphoneStock.dsx":0000
   Caption         =   "DataReport1"
   ClientHeight    =   3840
   ClientLeft      =   120
   ClientTop       =   465
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
            ...
            Strikethrough   =   0   'False
         EndProperty
         Object.Caption         =   "Headphone Stock"
      EndProperty
   EndProperty
   SectionCode1    =   2
   ...
   EndProperty
End
Attribute VB_Name = "HeadphoneStock"
